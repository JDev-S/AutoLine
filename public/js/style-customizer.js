		...
		****************************************/
		...
		if (!($.cookie('tp_stylesheet'))) {
			...
			$('.style-customizer .styleChange li[data-style="'+tp_stylesheet+'"]').addClass("selected");
			 ...
			 if (link.length>0) {
			 	link.attr('href','/css/' + tp_stylesheet + '.css');
			 	$('.style-customizer .styleChange li[data-style="'+tp_stylesheet+'"]').addClass("selected");
			 	if ($(".swicher-title-page-dark").length>0) {
			 		document.getElementById("logo_img").src="/images/logo_dark_swicher-title_" + tp_stylesheet + ".png";
			 	} else {
			 		if ($("#logo_img").length>0) {
			 			document.getElementById("logo_img").src="images/color-customizer/logo_" + tp_stylesheet + ".png";
			 		};
			 		if ($("#logo_dark_img").length>0) {
			 			document.getElementById("logo_dark_img").src="/images/logo_" + tp_stylesheet + ".png";
			 		};
			 		if ($("#logo-footer").length>0) {
			 			document.getElementById("logo-footer").src="/images/logo_" + tp_stylesheet + ".png";
			 		};
			 		if ($("#logo_footer_dark").length>0) {
						document.getElementById("logo_footer_dark").src="/images/logo_" + tp_stylesheet + ".png";
					};
			 	};
			 };
		};
		...
		$('.style-customizer .styleChange li').on('click',function(){
			if (link.length>0) {
			 ...
			 ($( $(this) ).index( '.style-customizer .styleChange li' ));
				...
				if ($(".swicher-title-page-dark").length>0) {
					document.getElementById("logo_img").src="/images/logo_dark_swicher-title_" + tp_stylesheet_no_cookie + ".png";
				} else {
					if ($("#logo_img").length>0) {
						document.getElementById("logo_img").src="/images/logo_" + tp_stylesheet_no_cookie + ".png";
					};
					if ($("#logo_dark_img").length>0) {
						document.getElementById("logo_dark_img").src="/images/logo_" + tp_stylesheet_no_cookie + ".png";
					};
					if ($("#logo-footer").length>0) {
						document.getElementById("logo-footer").src="/images/logo_" + tp_stylesheet_no_cookie + ".png";
					};
					if ($("#logo_footer_dark").length>0) {
						document.getElementById("logo_footer_dark").src="/images/logo_" + tp_stylesheet_no_cookie + ".png";
					};
				};
			};
		});
